...
@Page(AppRouteTable.PAGE_IMAGE_ADAPTER_DIAGNOSTICS)
                    ...
                    CenterAlignedTopAppBar(
                        ...
                        actions = {
                            Text(
                                ...
                                modifier = Modifier.clickable(onClick = navigator::back).padding(10.dp)
                            )
                        },
...
private val sample: DrawableResource by lazy(LazyThreadSafetyMode.NONE) {
    DrawableResource(
        ImageUri.pageAssets("sample.png").toUrl(AppRouteTable.PAGE_IMAGE_ADAPTER_DIAGNOSTICS)
    )
}
